...
/*SF_DATA;ver:0.20;sub:START;pass:START;ps:lgpr:1,nrmq:1,limd:1,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,uamb:True,mssp:True,ufog:True,aust:True,igpj:False,qofs:0,lico:1,qpre:1,flbk:,rntp:1,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,hqsc:True,hqlp:False,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0;n:type:ShaderForge.SFN_Final,id:1,x:32719,y:32712|diff-5-OUT;n:type:ShaderForge.SFN_Tex2d,id:3,x:33193,y:32638,ptlb:node_3,tex:d689a675abf43714ea4102df1522614b,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Vector3,id:4,x:33176,y:32803,v1:1,v2:1,v3:1;n:type:ShaderForge.SFN_Multiply,id:5,x:32978,y:32764|A-3-B,B-4-OUT;proporder:3;pass:END;sub:END;*/

Shader "Shader Forge/Ring_Metal_Shader" {
    Properties {
...
/////// Diffuse:
                ...
                finalColor += diffuseLight * (tex2D(_node3,TRANSFORM_TEX(i.uv0.rg, _node3)).b*float3(1,1,1));
/// Final Color:
